...
namespace NewRelic.Agent.Core.DataTransport
{
    ...
    public class ConnectionManagerTests
    {
        ...
        public async Task AttemptAutoStart_PublishesShutdownAgentEvent_IfCertainExceptionsOccur(Exception testData)
        {
            Mock.Arrange(() => _configuration.CollectorSyncStartup).Returns(true);
            Mock.Arrange(() => _configuration.AutoStartAgent).Returns(true);
        ...
        [Test]
        public async Task AttemptAutoStart_DoublesReconnectTimeForEachReconnect_UntilHittingFiveMinutes()
        {
            Mock.Arrange(() => _configuration.CollectorSyncStartup).Returns(true);
            Mock.Arrange(() => _configuration.AutoStartAgent).Returns(true);
